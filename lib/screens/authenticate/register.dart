                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (val) =>
                          val.isEmpty ? 'Podaj adres email' : null,
                      onChanged: (val) {
                        setState(() => email = val);
                      },
                    ...
                    TextFormField(
                      obscureText: true,
                      decoration:
                          textInputDecoration.copyWith(hintText: 'haslo'),
                      validator: (val) => val.length < 6
                          ? 'podane hasło powinno mieć wiecej ni 6 znaków'
                          : null,
                      onChanged: (val) {
                    ...
                    RaisedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState.validate()) {
                            ...
                            if (result == null) {
                              setState(() => error =
                                  ' podany eamil lub hasło jest błędne');
                              loading = false;
                            }
                          }
                        }),
